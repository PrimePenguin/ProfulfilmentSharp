...
namespace ProfulfilmentSharp.Entities.Requests
{
    ...
    public class ProfulfilmentProduct
    {
        /// <summary>
        ...
        [XmlElement(ElementName = "weightUnits")] public string WeightUnits { get; set; }
        [XmlElement(ElementName = "imageReference")] public string ImageReference { get; set; }
        [XmlElement(ElementName = "priceNet")] public double? PriceNet { get; set; }
        [XmlElement(ElementName = "priceGross")] public double? PriceGross { get; set; }
        [XmlElement(ElementName = "tax")] public double? Tax { get; set; }
        [XmlElement(ElementName = "taxCode")] public string TaxCode { get; set; }
        [XmlElement(ElementName = "currencyUnits")] public string CurrencyUnits { get; set; }
        [XmlElement(ElementName = "costNet")] public string CostNet { get; set; }
        [XmlElement(ElementName = "costGross")] public string CostGross { get; set; }
        [XmlElement(ElementName = "costTax")] public double? CostTax { get; set; }
        [XmlElement(ElementName = "costTaxCode")] public string CostTaxCode { get; set; }
        [XmlElement(ElementName = "costCurrency")] public string CostCurrency { get; set; }
        [XmlElement(ElementName = "costCurrencyUnits")] public string CostCurrencyUnits { get; set; }
        [XmlElement(ElementName = "userDefined1")] public string UserDefined1 { get; set; }
        [XmlElement(ElementName = "userDefined2")] public string UserDefined2 { get; set; }
        [XmlElement(ElementName = "userDefined3")] public string UserDefined3 { get; set; }
        [XmlElement(ElementName = "userDefined4")] public string UserDefined4 { get; set; }
        [XmlElement(ElementName = "userDefined5")] public string UserDefined5 { get; set; }
        [XmlElement(ElementName = "activated")] public string Activated { get; set; }
    ...
    {
        [XmlElement(ElementName = "import")] public ProfulfilmentProduct ProfulfilmentProduct { get; set; }
    }
}